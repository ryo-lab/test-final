let questions = [
    {
        "question":"RPG是Royal Playing Game？",
        "answers":[
            ["是的",0],
            ["不是",1]
        ]
    ...
    {
        "question":"dragon quest目前是否有第11版?",
        "answers":[
            ["是的",1],
            ["不是",0]
        ]
    ...
    {
        "question":"在全世界FINAL FANTASY VII的販賣量是多少？",
        "answers":[
            ["3,500,000",1],
            ["2,000,000",0],
            ["1,850,000",0]
    ...
    {
        "question":"Xenoblade出第一版的時候，用哪一個遊戲機玩的?",
        "answers":[
            ["play station",0],
            ["switch",0],
            ["Wii",1]
    ...
    {
        "question":"Kingdom Hearts有出過漫畫或小說嗎?",
        "answers":[
            ["有",1],
            ["沒有",0]
        ]
    ...
    {
        "question":"在日本寶可夢的動漫最高的收視率是否18.6%?",
        "answers":[
            ["是",1],
            ["否",0]
        ]
